 ...
 * The subclasses will do the problem logic, this abstract class just removes the need
 * to put logic in each subclass to handle IO and formatting of the standard output.
 */
